<template>
  <div class="product-info row">
    <div
      class="col-xs-12 col-xs-offset-0 col-sm-6 col-sm-offset-0"
      ...
      <ul class="product-authors">
        <li class="product-author" v-for="author in authorList">
          ...
          <div class="product-author-body">
            ...
            <div
              class="product-author-bio"
              v-html="author.authorDescribe"
            ></div>
          </div>
        </li>
      </ul>
      ...
      <ul class="product-authors">
        <li class="product-author" v-for="translator in translatorList">
          ...
          <div class="product-author-body">
            ...
            <div
              class="product-author-bio"
              v-html="translator.authorDescribe"
            ></div>
          </div>
        </li>
      </ul>
...
<script>
export default {
  props: ['author-list', 'translator-list']
};
</script>
